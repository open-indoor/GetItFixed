...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="_css/home_page_css.css" type="text/css" />
	...
	<body>
		<div id="wrapper">
			...
			<div id="content">
				...
				<?php 
					//include('./test_carte/OpenStreetMap-Base-de-donnees-master/home_map.html') 
					include('./includes/Maplibre/maplibre-gl-js-samples-main/maplibre_home_map.html') 
					//include('./includes/Gmaps/gmap_home_user.php') 
				?>
	...
	<script src="_js/my_script.js"></script>	
