...
if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
	...
	$q = "SELECT COUNT(rep_id) FROM greports WHERE rep_cat='$category_to_view' ";
...
// Make the query:
$q = "SELECT rep_name, rep_cat,rep_userid,rep_stat, DATE_FORMAT(rep_date, '%M %d, %Y') AS dr, rep_id FROM greports WHERE rep_cat='$category_to_view' ORDER BY $order_by LIMIT $start, $display";		
...
<tr>
	<th align="center" colspan="8"> <b>Reports from '.category_name($category_to_view).' </b> </th>
</tr>
<tr>
